...
# parse the expression and get all variables names  : 
...
# find where we have the same test cases : 
...
# verify if the test case exist or not : 
...
#check if a variable contains two of the same test cases : 
...
def verify_one_of_two_test_cases_already_exist(pair_of_test_cases , test_cases_to_verify):
    ...
    # verify for the first test case  : 
...
# check if the test case already exist or not : 
...
# append all the lists to one list : 
...
if __name__ == "__main__":
    ...
    formula = input("insert a logical expression (like A & B & C ) :")
    formula = formula.replace('&&', ' and ').replace('||', ' or ').replace('!', ' not ')
    variables = get_variables(formula)
    print("")
    print("")
    print("variables are : ",end="")
    variables.sort() # sort the variables to make it easy to read ! 
    print(variables)
    print("")
    ...
    print("test cases available ( without MC/CD ) are ("+ str(len(all_test_cases_with_results)) + " test cases ) : " )
    print("")
    
    formating_output(all_test_cases_with_results , variables)
    print("")
    print("test cases for each variable : ")
    print("")
    ...
    print("test cases available ( with MC/CD )  are ( "+str(len(final_result)) +" test cases )  : ")
    print("")
    print("")
